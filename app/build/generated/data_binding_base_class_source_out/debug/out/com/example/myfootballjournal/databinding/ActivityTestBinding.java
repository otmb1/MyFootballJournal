...
public final class ActivityTestBinding implements ViewBinding {
  ...
  @NonNull
  public final FragmentContainerView navHostFragmentActivity;

  @NonNull
  public final BottomNavigationView navView;

  private ActivityTestBinding(@NonNull ConstraintLayout rootView,
      @NonNull FragmentContainerView navHostFragmentActivity,
      @NonNull BottomNavigationView navView) {
    this.rootView = rootView;
    this.navHostFragmentActivity = navHostFragmentActivity;
  ...
  public static ActivityTestBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.nav_host_fragment_activity;
      FragmentContainerView navHostFragmentActivity = ViewBindings.findChildViewById(rootView, id);
      if (navHostFragmentActivity == null) {
        break missingId;
      }
      ...
      return new ActivityTestBinding((ConstraintLayout) rootView, navHostFragmentActivity, navView);
    }
